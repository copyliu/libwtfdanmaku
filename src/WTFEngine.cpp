...
namespace WTFDanmaku
{
    ...
    {
        return mController->Initialize(nullptr, initialWidth, initialHeight);
    }
    ...
    void WTFEngine::AddDanmaku(Type type, time_t time, const wchar_t* comment, int fontSize, int fontColor,
                               time_t timestamp, int danmakuId)
    {
    ...
    void WTFEngine::AddLiveDanmaku(Type type, time_t time, const wchar_t* comment, int fontSize, int fontColor,
                                   time_t timestamp, int danmakuId)
    {
        DanmakuRef danmaku = DanmakuFactory::CreateDanmaku(static_cast<DanmakuType>(type), time, std::wstring(comment),
                                                           fontSize, fontColor, timestamp, danmakuId);
